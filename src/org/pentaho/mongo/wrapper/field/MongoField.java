...
public class MongoField implements Comparable<MongoField> {
    ...
    public void init(int outputIndex) throws KettleException {
        ...
        Collections.addAll(m_pathParts, temp);
        ...
        m_tempValueMeta = new ValueMeta(null, ValueMeta.getType(m_kettleType));
    ...
    public Object getKettleValue(Object fieldValue) throws KettleException {
        ...
        switch (m_tempValueMeta.getType()) {
            ...
            case ValueMetaInterface.TYPE_BOOLEAN:
                if (fieldValue instanceof Number) {
                    fieldValue = ((Number) fieldValue).intValue() != 0;
                } else if (fieldValue instanceof Date) {
                    fieldValue = ((Date) fieldValue).getTime() != 0;
                } else {
                    fieldValue = fieldValue.toString().equalsIgnoreCase("Y") //$NON-NLS-1$
