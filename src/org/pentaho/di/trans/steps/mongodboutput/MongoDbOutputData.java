...
public class MongoDbOutputData extends BaseStepData implements StepDataInterface {
    ...
    public static void main(String[] args) {
        try {
            ...
            ValueMetaInterface vm = new ValueMeta("field1", ValueMetaInterface.TYPE_STRING);
            rmi.addValueMeta(vm);
            vm = new ValueMeta("field2", ValueMetaInterface.TYPE_STRING);
            rmi.addValueMeta(vm);
